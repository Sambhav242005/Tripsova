...
export function LoginScreen({ t, onSwitch, onSuccess }: LoginScreenProps) {
  ...
  return (
    <div style={{ padding: "40px 24px", maxWidth: 400, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 36 }}>
        ...
        <p style={{ fontSize: 13, color: t.muted, margin: 0 }}>Powered by Travellers — sign in to continue</p>
      </div>
